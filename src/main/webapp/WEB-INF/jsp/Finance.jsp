			...
			<div class="main">
				<section id="content">
					<div class="wrapper">
						<article class="col1">
							<div class="pad2">
								<h2 class="pad_bot1 pad_top1">Finance center</h2>
								<div class="wrapper">
									<figure class="left marg_right1"><img src="images/page5_img1.jpg" alt=""></figure>
									<p class="pad_bot1 color2"></p>
									<p>We take all major credit cards</p>
									<p>What is your preferred method to pay?</p>
								</div>
								<p></p>
					...
					<div class="wrapper">
						<article class="col1">
							<div class="pad2">
								<h2 class="pad_bot1">Commonly asked questions</h2>
								<div class="wrapper">
									<figure class="left marg_right1"><img src="images/page5_img2.jpg" alt=""></figure>
											<ul>
											<li><a href="#">How long can I stay?</a></li>
											<li><a href="#">Where can I stay?</a></li>
											<li><a href="#">How many stars?</a></li>
											<li><a href="#">Can I stay near an airport?</a></li>
											</ul>
							  </div>
								<p></p>
								<a href="#" class="button">Read more</a>
